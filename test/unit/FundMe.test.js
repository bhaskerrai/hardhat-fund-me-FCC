...
!developmentChains.includes(network.name) //using ternary operator here
    ? describe.skip
    : describe("FundMe", function () {
          ...
          beforeEach(async function () {
              ...
              fundMe = await ethers.getContract("FundMe", deployer) //getContract gets the most recent deployment of the contract we tell it.
          ...
          //     it("Fails if enough ETH are not sent", async function(){
